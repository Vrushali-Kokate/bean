...
//   try {
//     const menuContext = MENU_ITEMS.map(item => `${item.id}: ${item.name} (${item.description})`).join('\n');
...
//           type: Type.OBJECT,
//           properties: {
//             menuItemId: { type: Type.STRING, description: "The exact ID of the menu item recommended" },
//             reasoning: { type: Type.STRING, description: "A friendly explanation for the recommendation" }
//           },
